...
#This method computes statistical indexes and returns some useful indexes for graphs
    def index(self, openPrice_ar, closePrice_ar):
        ...
        print("Q0: 0% of Open Price: ", op_q0)
        print("Q1: 25% of Open Price: ", op_q1)
        print("Q2: 50% of Open Price: ", op_q2)
        print("Q3: 75% of Open Price: ", op_q3)
        print("Q4: 100% of Open Price: ", op_q4)
        cp_q0, cp_q1, cp_q2, cp_q3, cp_q4 = np.percentile(closePrice_ar, [0, 25, 50, 75, 100])
        print("Q0: 0% of Close Price: ", cp_q0)
        print("Q1: 25% of Close Price: ", cp_q1)
        print("Q2: 50% of Close Price: ", cp_q2)
        print("Q3: 75% of Close Price: ", cp_q3)
        print("Q4: 100% of Close Price: ", cp_q4)
