USER MANUAL - LEARN.PY

This program allows you to train a List of Model in order to choose the model which fits data in the best way.

At first start the program asks to the user the Training settings:
...
Next program plots graphic (if it's the case) and then it prints all Models Errors together to the Final Error (calculated on the Test Set) of the Best Model on Training phase.
